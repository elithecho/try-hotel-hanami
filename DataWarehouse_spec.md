# DataWarehouse Specification

This document specifies the expected data format for the hotel data warehouse.
...
### Required Fields
- `pub_id`: Unique hotel identifier (string)
- `destination_id`: Destination identifier (integer)
- `name`: Hotel name (string)
- `location`: Location object containing coordinates and address
- `description`: Hotel description (string)
- `amenities`: Categorized amenities object
- `images`: Categorized images object
- `booking_conditions`: Array of booking condition strings
...
### Amenities Object
- `general`: Array of general hotel amenities
- `room`: Array of room-specific amenities

### Images Object
- `rooms`: Array of room images
- `site`: Array of hotel exterior/site images
- `amenities`: Array of amenity images
